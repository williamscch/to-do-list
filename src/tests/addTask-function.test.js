...
import { addTaskStorage, getTasks } from '../modules/localStorage-functions.js';
import removeTask from '../modules/__mocks__/addTask-function.js';
...
describe('Test delete Items', () => {
  test('delete one item to the list', () => {
    ...
    const deleteBtn = document.querySelectorAll('#list div .delete');
